...
extension Book {
    static let lastWeek = Calendar.current.date(byAdding: .day, value: -7, to: Date.now)! // pega sete dias atras
    static let lastMonth = Calendar.current.date(byAdding: .month, value: -1, to: Date.now)! // pega 1 mes atras
    static var sampleBooks: [Book] {
        [
            ...
            Book(title: "Macbeth",
                 ...
                 status: Status.inProgress,recommendedBy: "MARIA"),
            Book(title: "Silence of the Grave",
                 ...
                 rating: 4,
                 status: Status.completed,recommendedBy: "MARIA"),
            Book(title: "Cardinal",
                 author: "Giles Blunt"),
            Book(title: "Jackdaws",
                 author: "Ken Follett",
